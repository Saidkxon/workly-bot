...
public class BotMessages {
    ...
    public static final String ENTER_DEPARTMENT_SELECTION = "Bo'limingizni tanlang:";
    public static final String INVALID_DEPARTMENT_SELECTION = "Iltimos, quyidagi tugmalardan birini tanlang.";
