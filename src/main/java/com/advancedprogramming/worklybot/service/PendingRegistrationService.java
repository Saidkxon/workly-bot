...
public class PendingRegistrationService {
    ...
    public PendingRegistration createPendingRegistration(Long telegramUserId, Long chatId, String fullName, String department, Shift shift) {
        ...
        pendingRegistration.setShift(shift);
